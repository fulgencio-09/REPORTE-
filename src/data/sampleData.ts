...
// Convenios predeterminados oficiales requeridos por el usuario
export const DEFAULT_PREDETERMINADOS_CONVENIOS = [
  'PROTEGER EPS SUBSIDIADO ASISTENCIAL MORBILIDAD Y PYM',
  'DUSAKAWI SUBSIDIADO PMS-44090-2026-12 PMT PYM',
  'DUSAKAWI SUBSIDIADO ASISTENCIAL ASB-44090-2026-20 CONSULTA MORBILIDAD',
  'NUEVA EPS SUBSIDIADO ASISTENCIAL MORBILIDAD',
  'NUEVA EPS SUBSIDIADO PYM'
];

export const DEFAULT_10_CONVENIOS = DEFAULT_PREDETERMINADOS_CONVENIOS;
